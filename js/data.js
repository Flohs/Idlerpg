...
(function () {
  ...
  D.MILESTONES = [
    { id: 'blacksmith', name: 'Cold Iron', cond: { floor: 3 }, unlocks: 'Blacksmith & Market: sell, salvage and upgrade gear.', tab: 'forge' },
    { id: 'craft', name: 'Sparks in the Dark', cond: { floor: 5 }, unlocks: 'Crafting: forge new gear from materials.', tab: 'forge' },
    { id: 'alchemist', name: 'Bitter Draughts', cond: { floor: 8 }, unlocks: 'Alchemist: automatic potions.', tab: 'village' },
    ...
    { id: 'guild', name: 'Names on the Wall', cond: { floor: 15 }, unlocks: 'Adventurers\' Guild: automation.', tab: 'village' },
    { id: 'enchant', name: 'Whispering Steel', cond: { floor: 20 }, unlocks: 'Enchanting: reroll affixes with Dark Essence. Party size 4 (Tavern 3). The Fungal Deep opens.', tab: 'forge' },
    { id: 'berserker', name: 'Red Snow', cond: { floor: 25 }, unlocks: 'Berserker can be recruited at the Tavern.', tab: 'heroes' },
    { id: 'mine', name: 'Deeper Veins', cond: { floor: 28 }, unlocks: 'Mine: passive scrap and gold, even offline.', tab: 'village' },
    { id: 'library', name: 'Forbidden Pages', cond: { floor: 30 }, unlocks: 'Library: XP and skill power. The Frozen Halls open.', tab: 'village' },
    { id: 'relics', name: 'What the Bosses Carry', cond: { floor: 35 }, unlocks: 'Relics: bosses drop permanent run modifiers.', tab: 'heroes' },
    { id: 'paladin', name: 'A Cracked Sun', cond: { floor: 40 }, unlocks: 'Paladin can be recruited. The Infernal Forge opens. Party size 5 (Tavern 6).', tab: 'heroes' },
    { id: 'abyss', name: 'No Bottom', cond: { floor: 50 }, unlocks: 'The Abyss opens. Mythic gear can drop.', tab: 'dungeon' },
    { id: 'ascension', name: 'Ascension', cond: { floor: 60 }, unlocks: 'Ascend: reset the dungeon for Embers and permanent power. Nightmare depths beyond 60.', tab: 'village' },
    { id: 'nightmare', name: 'The Second Descent', cond: { floor: 70 }, unlocks: 'Nightmare biomes: every dungeon returns, twisted and richer.', tab: 'dungeon' },
